...
model_path = "jonas/Bachelor/standard/standard_unet_kvasir.hdf5"
...
with open("standard_unet_training_duration_kvasir.txt", "w") as file:
...
savefig("standard_unet_fitting_curve_kvasir.png")